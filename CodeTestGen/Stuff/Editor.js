...
function setText(content) {
  ...
  if (content.includes('#include') || content.includes('int main') || content.includes('using namespace std')) {
      detectedLanguage = 'cpp';
  } else if (content.includes('def ') || content.includes('import ') || content.includes('print(')) {
      detectedLanguage = 'python';
  } else if (content.match(/\b(program|begin|end|var|integer|writeln)\b/i)) {
  ...
  if (detectedLanguage) {
      ...
      alert("Không thể xác định ngôn ngữ lập trình. Vui lòng chọn ngôn ngữ thủ công.");
  }
